...
describe Checks::ForemanOpenscap::ReportAssociations do
  include DefinitionsTestHelper

  subject do
    Checks::ForemanOpenscap::ReportAssociations.new
  end
  ...
  it 'fails when some reports with association issues detected' do
    ...
    assert_equal [Procedures::ForemanOpenscap::ReportAssociations], subject.next_steps.map(&:class)
  end
end